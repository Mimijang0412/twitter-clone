...
export default function InfiniteTweetList({ tweets, isError, isLoading, fetchNewTweets, hasMore }: InfiniteTweetListProps) {
  ...
  return (
    <li className="flex gap-4 border-b px-4 py-4">
      ...
      <div className="flex flex-grow flex-col">
        ...
        <HeartButton onClick={handleTogglLike} isLoading={toggleLike.isLoading} likedByMe={likedByMe} likeCount={likeCount} />
      </div>
